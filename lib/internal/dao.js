...
var Meetup = require('oae-bbb/lib/model').Meetup;
var Recording = require('oae-bbb/lib/model').Recording;
 ...
 * Get meetup by id
 *
 * @param  {String[]}       meetingId           The id of the meetings to get
 * @param  {String[]}       [fields]                The meeting fields to select. If unspecified, selects all of them
 * @param  {Function}       callback                Standard callback function
 * @param  {Object}         callback.err            An error that occurred, if any
 * @param  {Meeting[]}   callback.meetings    The meeting objects requested, in the same order as the meeting ids
 ...
 * Get recording by id
 *
 * @param  {String[]}       recordId           The id of the recordings to get
